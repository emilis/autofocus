<?php
/*
    Gluestick framework kernel with FirePHP debugging.
...
require_once LIB_DIR . '/FirePHPCore/fb.php';
...
{
    fb($obj_config, "loadObject($obj_name):config");
    global $_OBJECTS;
    ...
    fb($_OBJECTS[$obj_iname], "loadObject($obj_name):return");
...
{
    fb($obj_config, "newObjectInstance($obj_name):config");
    ...
    fb($donors[$obj_iname], "newObjectInstance($obj_iname):donor");
...
function &_createObject($obj_iname, $obj_config)
{
    ...
    fb($obj_config, "_createObject($obj_iname):config");
    ...
    fb($loadInfo, "_createObject($obj_iname):loadInfo");
...
{
    fb($object, "unloadObject($obj_name):object");
    ...
    fb($loadInfo, "unloadObject($obj_iname):loadInfo");
